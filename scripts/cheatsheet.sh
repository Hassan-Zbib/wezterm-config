...
row2 "F3"          "Launcher Menu"      "F8"               "Copy Mode"
...
header "🪟 Panes"
row2 "Alt+\\"      "Split Vertical"     "Alt+Ctrl+k"       "Focus Up"
row2 "Alt+Ctrl+\\" "Split Horizontal"   "Alt+Ctrl+j"       "Focus Down"
row2 "Alt+w"       "Close Pane"         "Alt+Ctrl+h"       "Focus Left"
row2 "Alt+Enter"   "Zoom Pane"          "Alt+Ctrl+l"       "Focus Right"
